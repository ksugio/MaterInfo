    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.PositiveSmallIntegerField(choices=[(0, 'SI'), (1, 'CGS'), (2, 'Percent')], default=0, verbose_name='Unit')),
                ('measured', models.FloatField(verbose_name='Measured')),
                ('theoretical', models.FloatField(blank=True, null=True, verbose_name='Theoretical')),
