    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ngen', models.PositiveIntegerField(default=100000, verbose_name='Number of generates')),
                ('modelfunc', models.TextField(blank=True, verbose_name='Model Function')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.FloatField(blank=True, null=True, verbose_name='Property')),
                ('note', models.TextField(blank=True, verbose_name='Note')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('upper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='design.design', verbose_name='Design')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localupd', models.BooleanField(default=False, verbose_name='Local updated')),
                ('prefix', models.CharField(blank=True, max_length=36, verbose_name='Prefix')),
                ('mode', models.PositiveSmallIntegerField(choices=[(0, 'List'), (1, 'Linspace'), (2, 'Continuous')], default=0, verbose_name='Mode')),
                ('values', models.CharField(max_length=256, verbose_name='Values')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
                ('upper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='design.design', verbose_name='Design')),
            ],
            options={
