...
from .views.token import GetAccessToken, GetSessionAccessToken, SetSessionRefreshToken, VerifyID, ParseURL
...
class CloneForm(forms.Form):
    ...
    def clean(self):
        ...
        rooturl, id = ParseURL(cleaned_data['url'], self.view_name, self.view_args)
