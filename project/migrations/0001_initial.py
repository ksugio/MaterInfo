    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'Active'), (1, 'Stop'), (2, 'Finish'), (3, 'Published')], default=0, verbose_name='Status')),
                ...
                ('member', models.ManyToManyField(related_name='project_member', to=settings.AUTH_USER_MODEL, verbose_name='Member')),
